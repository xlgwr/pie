...
namespace PIE.DAL
{
    ...
    public partial class plr_mstr
    {
        ...
        public bool Add(PIE.Model.plr_mstr model)
        {
            ...
            parameters[2].Value = model.plr_status;
            parameters[3].Value = model.packingListID;
            parameters[4].Value = model.InvoiceID;
            parameters[5].Value = model.plr_pallet_no;
            ...
            parameters[10].Value = model.plr_partno;
            parameters[11].Value = model.plr_date_code;
            parameters[12].Value = model.plr_vend_mfgr;
            parameters[13].Value = model.Plr_vm_partno;
            parameters[14].Value = model.plr_carton_qty;
            parameters[15].Value = model.plr_qty;
            parameters[16].Value = model.plr_rcp_date;
            parameters[17].Value = model.plr_deli_date;
            parameters[18].Value = model.carton_id_prifix;
            parameters[19].Value = model.carton_id_from;
            parameters[20].Value = model.carton_id_to;
            parameters[21].Value = model.plr_doc_type;
            parameters[22].Value = model.re_mark;
            parameters[23].Value = model.plr_suppliers_id;
            parameters[24].Value = model.plr_site;
            parameters[25].Value = model.plr_ttl;
            parameters[26].Value = model.plr_um;
            parameters[27].Value = model.plr_nw;
            parameters[28].Value = model.plr_gw;
            parameters[29].Value = model.plr_um_w;
            parameters[30].Value = model.Plr_unitprice;
            parameters[31].Value = model.plr_msm;
            parameters[32].Value = model.plr_doc_no1;
        ...
        public bool Update(PIE.Model.plr_mstr model)
        {
            ...
            parameters[1].Value = model.packingListID;
            parameters[2].Value = model.InvoiceID;
            parameters[3].Value = model.plr_pallet_no;
            parameters[4].Value = model.CartonType;
            parameters[5].Value = model.CartonID;
            parameters[6].Value = model.plr_po;
            parameters[7].Value = model.plr_co;
            parameters[8].Value = model.plr_partno;
            parameters[9].Value = model.plr_date_code;
            parameters[10].Value = model.plr_vend_mfgr;
            parameters[11].Value = model.Plr_vm_partno;
            parameters[12].Value = model.plr_carton_qty;
            ...
            parameters[17].Value = model.carton_id_from;
            parameters[18].Value = model.carton_id_to;
            parameters[19].Value = model.plr_doc_type;
            parameters[20].Value = model.re_mark;
            parameters[21].Value = model.plr_suppliers_id;
            parameters[22].Value = model.plr_site;
            parameters[23].Value = model.plr_ttl;
            parameters[24].Value = model.plr_um;
            parameters[25].Value = model.plr_nw;
            parameters[26].Value = model.plr_gw;
            parameters[27].Value = model.plr_um_w;
            parameters[28].Value = model.Plr_unitprice;
            parameters[29].Value = model.plr_msm;
            parameters[30].Value = model.plr_doc_no1;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Batch_ID,LineID,plr_status,packingListID,InvoiceID,plr_pallet_no,CartonType,CartonID,plr_po,plr_co,plr_partno,plr_date_code,plr_vend_mfgr,Plr_vm_partno,plr_carton_qty,plr_qty,plr_rcp_date,plr_deli_date,carton_id_prifix,carton_id_from,carton_id_to,plr_doc_type,re_mark,plr_suppliers_id,plr_site,plr_ttl,plr_um,plr_nw,plr_gw,plr_um_w,Plr_unitprice,plr_msm,plr_doc_no1,plr_cre_date,plr_cre_userid,plr_update_date,plr_edituser_id,plr_user_ip,plr_void_status,plr_chr01,plr_chr02,plr_deci1,plr_deci2 ");
