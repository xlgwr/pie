...
namespace PIE.DAL
{
    ...
    public partial class plr_mstr_log
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("LineID", "plr_mstr_log");
        }
        ...
        public bool Exists(string Batch_ID, string plr_partno, int LineID, int Wec_Ctn)
        {
            ...
            strSql.Append("select count(1) from plr_mstr_log");
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(PIE.Model.plr_mstr_log model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into plr_mstr_log(");
            strSql.Append("Batch_ID,LineID,Wec_Ctn,CartonNo,plr_wec_ctn,CartonID,CartonType,packingListID,InvoiceID,plr_site,plr_pallet_no,plr_po,plr_co,plr_partno,plr_date_code,plr_vend_mfgr,Plr_vm_partno,plr_qty,plr_rcp_date,plr_deli_date,carton_id_prifix,plr_status,plr_cre_date,plr_cre_userid,plr_update_date,plr_edituser_id,plr_user_ip,plr_void_status,plr_chr01,plr_chr02,plr_deci1,plr_deci2)");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@LineID", SqlDbType.Int,4),
					new SqlParameter("@Wec_Ctn", SqlDbType.Int,4),
					new SqlParameter("@CartonNo", SqlDbType.Int,4),
            ...
            parameters[3].Value = model.CartonNo;
            parameters[4].Value = model.plr_wec_ctn;
            parameters[5].Value = model.CartonID;
            parameters[6].Value = model.CartonType;
            parameters[7].Value = model.packingListID;
            parameters[8].Value = model.InvoiceID;
            parameters[9].Value = model.plr_site;
            parameters[10].Value = model.plr_pallet_no;
            parameters[11].Value = model.plr_po;
            parameters[12].Value = model.plr_co;
            parameters[13].Value = model.plr_partno;
            parameters[14].Value = model.plr_date_code;
            parameters[15].Value = model.plr_vend_mfgr;
            parameters[16].Value = model.Plr_vm_partno;
            parameters[17].Value = model.plr_qty;
            parameters[18].Value = model.plr_rcp_date;
            parameters[19].Value = model.plr_deli_date;
            parameters[20].Value = model.carton_id_prifix;
            parameters[21].Value = model.plr_status;
            parameters[22].Value = model.plr_cre_date;
            parameters[23].Value = model.plr_cre_userid;
            parameters[24].Value = model.plr_update_date;
            parameters[25].Value = model.plr_edituser_id;
            parameters[26].Value = model.plr_user_ip;
            parameters[27].Value = model.plr_void_status;
            parameters[28].Value = model.plr_chr01;
            parameters[29].Value = model.plr_chr02;
            parameters[30].Value = model.plr_deci1;
            parameters[31].Value = model.plr_deci2;
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(PIE.Model.plr_mstr_log model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update plr_mstr_log set ");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@plr_cre_date", SqlDbType.DateTime),
					new SqlParameter("@plr_update_date", SqlDbType.DateTime)};
            parameters[0].Value = model.CartonNo;
            parameters[1].Value = model.plr_wec_ctn;
            parameters[2].Value = model.CartonID;
            parameters[3].Value = model.CartonType;
            parameters[4].Value = model.packingListID;
            parameters[5].Value = model.InvoiceID;
            parameters[6].Value = model.plr_site;
            parameters[7].Value = model.plr_pallet_no;
            parameters[8].Value = model.plr_po;
            parameters[9].Value = model.plr_co;
            parameters[10].Value = model.plr_date_code;
            parameters[11].Value = model.plr_vend_mfgr;
            parameters[12].Value = model.Plr_vm_partno;
            parameters[13].Value = model.plr_qty;
            parameters[14].Value = model.plr_rcp_date;
            parameters[15].Value = model.plr_deli_date;
            parameters[16].Value = model.carton_id_prifix;
            parameters[17].Value = model.plr_status;
            parameters[18].Value = model.plr_cre_userid;
            parameters[19].Value = model.plr_edituser_id;
            parameters[20].Value = model.plr_user_ip;
            parameters[21].Value = model.plr_void_status;
            parameters[22].Value = model.plr_chr01;
            parameters[23].Value = model.plr_chr02;
            parameters[24].Value = model.plr_deci1;
            parameters[25].Value = model.plr_deci2;
            parameters[26].Value = model.Batch_ID;
            parameters[27].Value = model.LineID;
            parameters[28].Value = model.Wec_Ctn;
            parameters[29].Value = model.plr_partno;
            parameters[30].Value = model.plr_cre_date;
            parameters[31].Value = model.plr_update_date;
        ...
        public bool Delete(string Batch_ID, string plr_partno, int LineID, int Wec_Ctn)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from plr_mstr_log ");
            strSql.Append(" where Batch_ID=@Batch_ID and plr_partno=@plr_partno and LineID=@LineID and Wec_Ctn=@Wec_Ctn ");
            SqlParameter[] parameters = {
					new SqlParameter("@Batch_ID", SqlDbType.VarChar,20),
					new SqlParameter("@plr_partno", SqlDbType.VarChar,30),
        ...
        /// 得到一个对象实体
        /// </summary>
        public PIE.Model.plr_mstr_log GetModel(string Batch_ID, string plr_partno, int LineID, int Wec_Ctn)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 Batch_ID,LineID,Wec_Ctn,CartonNo,plr_wec_ctn,CartonID,CartonType,packingListID,InvoiceID,plr_site,plr_pallet_no,plr_po,plr_co,plr_partno,plr_date_code,plr_vend_mfgr,Plr_vm_partno,plr_qty,plr_rcp_date,plr_deli_date,carton_id_prifix,plr_status,plr_cre_date,plr_cre_userid,plr_update_date,plr_edituser_id,plr_user_ip,plr_void_status,plr_chr01,plr_chr02,plr_deci1,plr_deci2 from plr_mstr_log ");
            strSql.Append(" where Batch_ID=@Batch_ID and plr_partno=@plr_partno and LineID=@LineID and Wec_Ctn=@Wec_Ctn ");
            SqlParameter[] parameters = {
					new SqlParameter("@Batch_ID", SqlDbType.VarChar,20),
					new SqlParameter("@plr_partno", SqlDbType.VarChar,30),
            ...
            PIE.Model.plr_mstr_log model = new PIE.Model.plr_mstr_log();
        ...
        /// 得到一个对象实体
        /// </summary>
        public PIE.Model.plr_mstr_log DataRowToModel(DataRow row)
        {
            PIE.Model.plr_mstr_log model = new PIE.Model.plr_mstr_log();
            if (row != null)
            {
                ...
                if (row["CartonNo"] != null && row["CartonNo"].ToString() != "")
                {
                    model.CartonNo = int.Parse(row["CartonNo"].ToString());
                }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Batch_ID,LineID,Wec_Ctn,CartonNo,plr_wec_ctn,CartonID,CartonType,packingListID,InvoiceID,plr_site,plr_pallet_no,plr_po,plr_co,plr_partno,plr_date_code,plr_vend_mfgr,Plr_vm_partno,plr_qty,plr_rcp_date,plr_deli_date,carton_id_prifix,plr_status,plr_cre_date,plr_cre_userid,plr_update_date,plr_edituser_id,plr_user_ip,plr_void_status,plr_chr01,plr_chr02,plr_deci1,plr_deci2 ");
            strSql.Append(" FROM plr_mstr_log ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from plr_mstr_log T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "plr_mstr_log";
