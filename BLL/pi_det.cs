...
namespace PI.BLL
{
    ...
    public partial class pi_det
    {
        ...
        {
            return dal.Exists(PI_ID, pi_LineID, pi_wec_ctn);
        }
        ...
        public PI.Model.pi_det GetModelByCache(string PI_ID, int pi_LineID, string pi_wec_ctn)
        {
            ...
            if (objModel == null)
            {
                try
                {
                    objModel = dal.GetModel(PI_ID, pi_LineID, pi_wec_ctn);
                    if (objModel != null)
                    {
            ...
            return (PI.Model.pi_det)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<PI.Model.pi_det> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<PI.Model.pi_det> DataTableToList(DataTable dt)
        {
