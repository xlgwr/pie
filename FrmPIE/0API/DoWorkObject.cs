...
namespace FrmIDR._0API
{
    class DoWorkObject
    {
        ...
        public DoWorkObject(frmIDR idr_show, DataGridView dgv, int selectedindex, int eIndex, Color colors, string sameColumnNameCount, string sameColumnNameCountValut, string sameColumnName, string deffCellName, string deffCellValue, Color Deffcolors, string compMaxMin)
        {
            _FrmForRefeHas = false;
            _dgv = dgv;
            _selectedindex = selectedindex;
        ...
        public DoWorkObject(frmIDR idr_show, DataGridView dgv, int selectedindex, int eIndex, Color colors, string sameColumnName, string deffCellName, string deffCellValue, Color Deffcolors, string compMaxMin)
        {
            _FrmForRefeHas = false;
            _dgv = dgv;
            _selectedindex = selectedindex;
        ...
        public DoWorkObject(DataGridView dgv, DataGridView dgv1, string strBatchId)
        {
            _FrmForRefeHas = false;
            _dgv = dgv;
            _dgv1 = dgv1;
        ...
        public DoWorkObject(DataGridView dgv, int ex, int ey, bool haslineid, string voidColumn)
        {
            _FrmForRefeHas = false;
            _dgv = dgv;
            _eX = ex;
        ...
        public DoWorkObject(DataGridView dgv, string strBatchId)
        {
            _FrmForRefeHas = false;
            _dgv = dgv;
            _strBatchId = strBatchId;
